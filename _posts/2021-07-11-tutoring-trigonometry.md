...
- 참고: 삼각함수의 정의
    ...
    $$
\begin{align*}
\tan{t}=\frac{\sin{t}}{\cos{t}} \\ \sec{t}=\frac{1}{\cos{t}} \\ \csc{t}=\frac{1}{\sin{t}} \\ \cot{t}=\frac{\cos{t}}{\sin{t}}
\end{align*}
$$
...
$$
\begin{align*}
\cos^2{\theta}+\sin^2{\theta}=1\\ 1+\tan^2\theta=\sec^2{\theta}
\end{align*}
$$
