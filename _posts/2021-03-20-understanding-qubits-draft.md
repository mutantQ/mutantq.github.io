...
여기서 $z\_1 = -z\_0$이므로 $z\_0$와 $z\_1$은 $180\degree$ 위상차를 가지고, $z\_2 = iz\_0$이므로 $z\_0$와 $z\_2$는 $90\degree$ 위상차를 가진다.
...
앞서 정의한 복소수 $z\_0 = 1+i$와 $z\_1 = -1-i$를 다시 보자. 이 두 복소수는 $180\degree$ 위상차를 가지고 있다 ($z\_1 = -z\_0$). 만약 양자 연산을 통해 이 두 진폭이 더해진다면 $z\_0 + z\_1 = 0$이 되어 완전히 상쇄된다. 

반면 $z\_0 = 1+i$와 $z\_2 = -1+i$는 $90\degree$ 위상차를 가진다 ($z\_2 = iz\_0$). 이들을 더하면 $z\_0 + z\_2 = 2i$로 소멸하지 않는다.
